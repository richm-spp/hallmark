...
- [`brands/README.md`](references/brands/README.md) — whenever a brand is active (pre-flight signal 6); it carries the brand-token contract the brand file's header binds to.
